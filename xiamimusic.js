...
//该值决定了当检测到您不是虾米VIP会员时是否会向远程服务器请求数据;
const isRemote=true;
...
var songsList=(function(){
    ...
    shareurl="http://duoluohua.com/myapp/api/xiami/share/?action=share",nowQuerySongUrl="",
    ...
    queryUrl="http://duoluohua.com/myapp/api/xiami/getsong/?action=geturl&fromid=xiamimusicscript&version="+version,
    msgArr=[
...
function showUerInfo(text){
	...
	updateNode.innerHTML='<div align="center" ><a target="_blank" href="http://duoluohua.com/download/?fromid=xiami_music_script"><img id="updateimg" style="display:none;"/></a></div>';
	node.innerHTML=html;
	o.appendChild(node);
